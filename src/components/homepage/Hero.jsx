...
export default function Hero({ partners }) {
  ...
  for (let i = 0; i < partners.length; i++) {
    nodes.push({
      ...
      top: `calc(${
        Math.sin(i * interval * (Math.PI / 180) + Math.PI / 4) * 38
      }% + 50%)`,
      left: `calc(${
  ...
  return (
    <div className="w-100 py-0 hero">
      <div style={{ backgroundColor: "#000203" }} className="pb-3">
        <div
          ...
          >
            ...
            >
              <h1 className={`display-5 fw-bold mb-4 ${styles.headline}`}>
                Powering Digital & AI Transformation
                <br />
                <span className={styles.highlight}>in the GCC & Beyond</span>
              </h1>
              <p className={`lead fs-3 mb-4 ${styles.subheadline}`}>
                Omintel connects banks, financial services, and large
                institutions to
                <span className="text-white-80"> globally proven</span> Digital
                & AI SaaS solutions —
                <span className="fw-semibold text-white">
                  {" "}
                  tailored for GCC and African markets
                </span>
                .
              </p>
            </div>
            ...
            <ul className={`list-unstyled ${styles.styledList}`}>
              <li className="py-3 px-3">
                <div className="d-flex align-items-center">
                  ...
                  <span className={`${styles.listItem} fs-4`}>
                    Too many choices
                  </span>
                </div>
              </li>
              ...
              <li className="py-3 px-3">
                <div className="d-flex align-items-center">
                  ...
                  <span className={`${styles.listItem} fs-4`}>
                    Projects stalling before impact
                  </span>
                </div>
              </li>
            </ul>
        ...
        <div className={"col-lg-7 mb-4 " + styles.diagramContainer}>
          <div className={styles.interactiveDiagram}>
            ...
            {nodes.map((node) => (
              <div
                key={node.id}
                className={`${styles.satelliteLogo} ${
                  isDiagramOpen ? styles.scattered : ""
                }`}
                style={{
                  top: node.top,
                  left: node.left,
      ...
      <div className={`${styles.advantageSection} mt-5 py-5`}>
        <div className="row justify-content-center">
          <div className="col-lg-8 text-center">
            ...
            <div
              className={`${styles.advantageList} row justify-content-center`}
            >
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className={`${styles.advantageCard} h-100 p-4`}>
                  ...
                  <p>
                    Compliance-ready, culturally adapted, deployment-friendly
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className={`${styles.advantageCard} h-100 p-4`}>
                  ...
                  <p>
                    We start with your business problem, not a product pitch
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className={`${styles.advantageCard} h-100 p-4`}>
                  ...
                  <p>
                    We manage contracts, delivery, and success metrics
                    end-to-end
                  </p>
                </div>
              </div>
